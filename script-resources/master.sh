...
target/script-resources/tweets.sh $request_id "${request_id}/tweets.txt" "${request_id}/${request_id}_background.jpeg"
target/script-resources/video.sh $request_id $audio_track 
